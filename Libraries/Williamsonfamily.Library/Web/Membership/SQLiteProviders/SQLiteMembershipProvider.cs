...
namespace WilliamsonFamily.Library.Web.Membership.SQLiteProviders
{
    public sealed class SQLiteMembershipProvider : MembershipProvider
    {
        ...
        private const string encryptionKey = "AE09F72BA97CBBB6"; 
        #endregion

        #region Properties
        // TODO: Use another means of logging. Log4Net?
        /// <summary>
        ...
        private int _minRequiredNonAlphanumbericCharacter;
        public override int MinRequiredNonAlphanumericCharacters { get { return _minRequiredNonAlphanumbericCharacter; } }
        ...
        public override void Initialize(string name, NameValueCollection config)
        {
            ...
            _minRequiredNonAlphanumbericCharacter = Convert.ToInt32(GetConfigValue(config["minRequiredNonAlphanumericCharacters"], "1"));
            ...
            try
            {
                ...
                if (reader.HasRows)
                {
                    ...
                    if (userIsOnline)
                    {
                        ...
                        updateCmd.Parameters.Add("$ApplicationName", DbType.String, 255).Value = ApplicationName;
