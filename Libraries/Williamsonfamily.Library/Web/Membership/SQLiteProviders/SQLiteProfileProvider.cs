...
namespace WilliamsonFamily.Library.Web.Membership.SQLiteProviders
{
    public sealed class SQLiteProfileProvider : ProfileProvider
    {
        ...
        #region ProfileProvider Properties
        ...
        #region ProfileProvider Methods
        ...
        public override void SetPropertyValues(SettingsContext sc, SettingsPropertyValueCollection properties)
        {
            try
            {
                ...
                try
                {
                    ...
                    {
                        cmd = new SQLiteCommand("UPDATE aspnet_Profile SET PropertyNames ='" + names +
                            "', PropertyValuesString ='" + values +
                            "', LastUpdatedDate ='" + DateTime.Now.ToString("yyyy:MM:dd hh:mm:ss") + 
                            "' WHERE PKID ='" + PKID + "'", conn, trans);
                    }
                    else
                    {
                        cmd = new SQLiteCommand("INSERT INTO aspnet_Profile (PKID, PropertyNames, PropertyValuesString, LastUpdatedDate) VALUES ('" 
                            + PKID + "','" + names + "','" + values + "','" + 
                            DateTime.Now.ToString("yyyy:MM:dd hh:mm:ss") + "')", conn, trans);
                    }
        ...
        public override int DeleteInactiveProfiles(ProfileAuthenticationOption authenticationOption, DateTime userInactiveSinceDate)
        {
            ...
            string inClause = "SELECT PKID FROM users WHERE ApplicationId ='" + appId +
                "' AND LastActivityDate <= '" + userInactiveSinceDate.ToString("yyyy:MM:dd hh:mm:ss") + 
        ...
        #region GetPropertyValiesFromDatabase
        ...
        #region GetClauseForAuthenticationOptions
